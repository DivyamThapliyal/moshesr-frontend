/* ============================================================================
   Icon — the Lucide line-icon set, ported verbatim from js/icons.js.
   24 viewBox, stroke 2, round caps and joins, no fills. A glyph rendered here
   is identical to the original. `dangerouslySetInnerHTML` injects the raw path
   markup because these paths are static, author-controlled constants — never
   user input — so there is no XSS surface.
   ========================================================================== */
...
export const ICON_PATHS = {
  ...
  bell: '<path d="M18 8a6 6 0 0 0-12 0c0 6-2 7-2 7h16s-2-1-2-7"/><path d="M10.5 20a1.8 1.8 0 0 0 3 0"/>',
  ellipsis: '<circle cx="5" cy="12" r="1.1"/><circle cx="12" cy="12" r="1.1"/><circle cx="19" cy="12" r="1.1"/>',
  ...
  trash: '<path d="M4 7h16"/><path d="M18 7v12a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2V7"/><path d="M9.5 7V5a1.5 1.5 0 0 1 1.5-1.5h2A1.5 1.5 0 0 1 14.5 5v2"/><path d="M10 11.5v6M14 11.5v6"/>',
  ...
  'file-plus': '<path d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z"/><path d="M14 2v4a2 2 0 0 0 2 2h4"/><path d="M12 12v6"/><path d="M9 15h6"/>',
